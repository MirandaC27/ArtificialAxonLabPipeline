...
* Note: i would also recomment keeping the create shortcut, if regestering Anaconda does not work. You can open the Anaconda Prompt and run the command `conda init` and close out and it should work in any terminal.
